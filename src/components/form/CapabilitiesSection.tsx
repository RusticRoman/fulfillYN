...
const wmsOptions = [
  ...
  { value: 'full_send_pcms', label: 'Full Send PCMS' },
  { value: 'hopstack', label: 'Hopstack' },
  { value: 'infor', label: 'Infor SCM' },
  { value: 'inventis', label: 'Inventis' },
  { value: 'logiwa', label: 'Logiwa' },
  { value: 'manhattan', label: 'Manhattan Associates' },
  { value: 'netsuite', label: 'NetSuite WMS' },
  { value: 'packiyo', label: 'Packiyo' },
  { value: 'prepbusiness', label: 'PrepBusiness' },
  { value: 'proprietary', label: 'Proprietary' },
  { value: 'ramp_systems', label: 'RAMP Systems' },
  { value: 'regal_suite', label: 'Regal Suite' },
  { value: 'sellercloud', label: 'Sellercloud' },
  { value: 'shiphero', label: 'ShipHero' },
  { value: 'shipmonk', label: 'ShipMonk' },
  { value: 'shiprelay', label: 'ShipRelay' },
  { value: 'shipstation', label: 'ShipStation' },
  { value: 'skubana', label: 'Skubana' },
  { value: 'skuit', label: 'SKUit' },
  { value: 'skustack', label: 'SkuStack' },
  { value: 'synapse', label: 'Synapse' },
  { value: 'veracore', label: 'VeraCore' },
  { value: 'warehouse_os', label: 'Warehouse OS' },
  { value: 'zenventory', label: 'Zenventory' },
